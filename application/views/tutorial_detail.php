...
<section class="global-page-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="block">
                            <h2><?php echo $tutorial[0]->title;?></h2>
                            <div class="portfolio-meta">
                                <span><?php echo $day[$tgl].', '.$tutorial[0]->date?></span>|
                               <span> <?php echo $tutorial[0]->name_category;?></span>|
                               <span> source :<u> <?php echo $tutorial[0]->source?></a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="single-post">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="post-img">
                                <img class="img-responsive" alt="" src="<?php echo base_url()?>uploads/resize/<?php echo $tutorial[0]->file_name;?>">
                            </div>
                            <div class="post-content">
                                <p>
                                    <?php echo $tutorial[0]->desc;?>
                                </p>
                    ...
                    <div class="post-comment">
                                ...
                                <input type="hidden" name="idtutor" value="<?php echo $tutorial[0]->id_tutor;?>">
