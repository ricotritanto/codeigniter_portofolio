                    ...
                    {?>
                            <article class="wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">
                                <div class="blog-post-image">
                                    <a href="<?php echo base_url('corp/v_news/'.$key->id_news);?>"><img class="img-responsive" src="<?php echo base_url()?>uploads/resize/<?php echo $key->file_name;?>" alt="" /></a>
                                </div>
                            ...
                            <div class="sidebar">
                                <div class="search widget">
                                    ...
                                    <div class="categories widget">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="">Sport</a> <span class="badge"><?php echo count($blog);?></span>
                                            </li>
                                            <li>
                                                <a href="">Traveling</a> <span class="badge"><?php echo count($traveling);?></span>
                                            </li>
                                            <li>
                                   ...
                                   <div class="recent-post widget">
                                        ...
                                        <?php foreach ($news as $key) {?>
                                         ...
                                         <?php   } ?>
                                            <!-- <li>
                                                <a href="#"><?php echo $news[4]->title;?></a><br>
                                                <time><?php echo $news[4]->date;?></time>
                                            </li> -->
                                        </ul>
